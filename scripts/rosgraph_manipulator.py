...
goal_yaml_file_name = rospy.get_param('/current_goal_yaml_file',
                                      rospack.get_path('metacontrol_sim')
                                      + '/yaml/goal.yaml')
...
class RosgraphManipulatorActionServer (object):
    ...
    def __init__(self, name):
        ...
        self._movebase_client = actionlib.SimpleActionClient('move_base',
                                                             MoveBaseAction)
    ...
    def execute_cb(self, goal):
        rospy.loginfo('Rosgraph Manipulator AS received goal %s' % str(goal))
